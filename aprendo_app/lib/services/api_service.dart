  ...
  Future<List<Game>> getGames() async {
    try {
      ...
      if (response.statusCode == 200) {
        print(
          '[DEBUG][ApiService] body snippet: ${response.body.substring(0, response.body.length > 200 ? 200 : response.body.length)}',
        );
        ...
        print(
          '[ERROR][ApiService] Failed to fetch games: ${response.statusCode}',
        );
